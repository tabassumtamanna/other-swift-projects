...
class PlaySoundsViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        //retrive the slider location
        sliderView.value = UserDefaults.standard.float(forKey: "sliderValue")
    ...
    @IBAction func playAudio(_ sender: UIButton) {
        ...
        UserDefaults.standard.setValue(sliderView.value, forKey: "sliderValue")
